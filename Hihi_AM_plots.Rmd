...
which.sites <- which(site.names%in%site.names[c(2,6,13)])
...
cairo_pdf(file="Fig_5_learning_all.pdf",width=143/25.4, height=110/25.4, pointsize=5,antialias = "subpixel")
