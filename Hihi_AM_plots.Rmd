...
cairo_pdf(file="Fig_2_summaries.pdf",width=120/25.4, height=90/25.4, pointsize=5,antialias = "subpixel")
...
fig4.df$Variable <- factor(fig4.df$Variable,levels=levels(fig4.df$Variable)[c(1,3,2,4)])
...
my.cols <- get_pal("Hihi") #brewer.pal(7, "Set1") # One colour for each action
cairo_pdf(file="Fig_4_cumulative.pdf",width=120/25.4, height=90/25.4, pointsize=5,antialias = "subpixel")
...
which.strategies <- run.strategies #c(1,4,5)
