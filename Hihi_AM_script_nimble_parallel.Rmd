...
n.sims <- (max.cores-1)*n.reps; n.years <- 10; feed.levels <- 2 # Simulation settings 
ni <- 1000; nb <- 500; nt <- 1; nc <- 3 # MCMC settings
this.seed <- 123

# Which strategies to run?
run.strategies <- c(1,2,5,7)
...
set.seed(123) # Change or fix for stochasticity among strategies
